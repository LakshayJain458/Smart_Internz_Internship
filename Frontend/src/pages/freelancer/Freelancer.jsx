...
const Freelancer = () => {
  ...
  const fetchUserData = async(id) =>{
      axios.get(`http://localhost:3000/fetch-freelancer/${id}`).then(
        (response)=>{
  ...
  const updateUserData = async() =>{
    axios.post(`http://localhost:3000/update-freelancer`, {freelancerId, updateSkills: updateSkills, description: updateDescription}).then(
        (response)=>{
          fetchUserData();
